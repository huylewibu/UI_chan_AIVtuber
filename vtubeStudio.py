...
from constants import VTUBE_MODEL_POSITIONS, VTUBE_MIC_POSITION, VTUBE_ITEM_IMG
...
class VtubeStudio(Module):
    ...
    async def run(self):
        ...
        try:
            ...
            if self.vts.websocket is None:
                raise Exception("Failed to connect to Vtube Studio. Disabling Vtube Studio module.")
        except:
